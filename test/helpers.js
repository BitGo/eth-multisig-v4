...
exports.accounts = [
  ...
  if (privkey.length !== 32) {
    throw new Error(`Invalid private key length: ${privkey.length}, expected 32 bytes`);
  }
...
exports.privateKeyForAccount = function(account) {
  ...
  const currentEnvironmentMapping = {
    '0xB1b359CB06B3a40c53b2fa5Ec112214626bc187A': '0xc8209c2200f920b11a460733c91687565c712b40c6f0350e9ad4138bf3193e47', // deployer
    '0xbcBD7ec77f3f286BDaFcDE2A3720E39e93A726C6': '0x915334f048736c64127e91a1dc35dad86c91e59081cdc12cd060103050e2f3b1', // signer1
    '0x0BB0cB323c4DB61AA1f7d569dbDAa773A21daC58': '0x80bf357dd53e61db0e68acbb270e16fd42645903b51329c856cf3cb36f180a3e', // signer2
  };
  ...
  if (!privateKeyHex) {
    const originalPrivKey = mapAddrToAcct[util.stripHexPrefix(account).toLowerCase()];
    if (originalPrivKey) {
